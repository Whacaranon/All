...
local function RippleEffect(object)
	spawn(function()
		...
		Ripple.BackgroundColor3 = Color3.fromRGB(255, 0, 255)
...
function SomeLib:Window(text,mainclr,cls)
	local PresetColor = mainclr or Color3.fromRGB(255,0,255) or _G.Color
	...
	UserCircleImage.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
local win = SomeLib:Window("STEAL ALL MAP", _G.Color, _G.Toggle)

local serv = win:Server("STEAL HUB","")
...
Client = AutoFarm:Label("Ping Server")
...
AutoFarm:Button("Copy PlaceId", function()
setclipboard(tostring(game.PlaceId))
end)

AutoFarm:Button("Copy CFreme", function()
setclipboard(tostring(game.Players.LocalPlayer.Character.HumanoidRootPart.Position))
end)

AutoFarm:Button("Remote Spy", function()
loadstring(game:HttpGet("https://github.com/exxtremestuffs/SimpleSpySource/raw/master/SimpleSpy.lua"))()
end)

AutoFarm:Button("Unlock FPS",function(a)
        setfpscap(240)
    end)

local PLAYER = serv:Channel("PLAYER", "http://www.roblox.com/asset/?id=6034509993")

PLAYER:Slider("WalkSpeed",0,500,50, function(t)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = t
end)

PLAYER:Slider("Jump Hight",0,500,50, function(value)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = value
end)
PLAYER:Slider("Gravity",0,500,196, function(t)
    workspace.Gravity = t
end)

PLAYER:Toggle("Noclip",false, function(t)
    noclip = t
end)
...
PLAYER:Toggle("ESP",false, function(t)
  ESPPlayer = value
