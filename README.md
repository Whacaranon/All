...
local Home = Win:Tab("• Player","6034509993")
local Miss = Win:Tab("• Miss","6034509993")
-- Section --
local A = Main:NewSection("HElP For SC")
local P = Home:NewSection("")
local M = Miss:NewSection("Miss")
...
A:Button("Unlock FPS",function(a)
        setfpscap(240)
    end)
 ...
 PlayerName = {}
    ...
    local SelectedPly = P:Dropdown("Select Players",PlayerName,function(value)
        _G.SelectPly = value
    end)
    ...
    P:Toggle("Auto Kill Player",false,function(value)
    ...
    P:Dropdown("Select Method",{"Behind","Below","Upper"},function(value)
        _G.Method2 = value
    end)
    ...
    Distanceply = 1
    P:Slider("Distance",1,100,1,function(value)
        Distanceply = value
    end)
    ...
    P:Button("Refresh Weapon",function()
...
M:Slider("WalkSpeed",0,500,50, function(t)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = t
end)

M:Slider("Jump Hight",0,500,50, function(value)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = value
end)
M:Slider("Gravity",0,500,196, function(t)
    workspace.Gravity = t
end)

M:Toggle("Noclip",false, function(t)
    noclip = t
end)
