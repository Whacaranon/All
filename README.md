...
P:Slider("WalkSpeed",0,500,50, function(t)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = t
end)

P:Slider("Jump Hight",0,500,50, function(value)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = value
end)
P:Slider("Gravity",0,500,196, function(t)
    workspace.Gravity = t
end)

P:Toggle("Noclip",false, function(t)
    noclip = t
end)
